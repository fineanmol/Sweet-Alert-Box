...
import ndc.sweetalertbox.OptAnimationLoader.loadAnimation
...
class SweetAlertDialog @JvmOverloads constructor(
    ...
    override fun onCreate(savedInstanceState: Bundle) {
        ...
        mSuccessTick =
            mSuccessFrame!!.findViewById<View>(R.id.success_tick) as SuccessTickView
        mSuccessLeftMask = mSuccessFrame!!.findViewById(R.id.mask_left)
        mSuccessRightMask = mSuccessFrame!!.findViewById(R.id.mask_right)
        mCustomImage =
            findViewById<View>(R.id.custom_image) as ImageView
        mWarningFrame = findViewById<View>(R.id.warning_frame) as FrameLayout
        mConfirmButton =
            findViewById<View>(R.id.confirm_button) as Button
        mCancelButton =
    ...
    init {
        ...
        alerType = alertType
        mErrorInAnim =
            loadAnimation(getContext(), R.anim.error_frame_in)
        mErrorXInAnim = loadAnimation(
            getContext(),
            R.anim.error_x_in
        ) as AnimationSet?
...
// remove it from animation set
        ...
        mSuccessBowAnim = loadAnimation(
            getContext(),
            R.anim.success_bow_roate
        )
        mSuccessLayoutAnimSet = loadAnimation(
            getContext(),
            R.anim.success_mask_layout
        ) as AnimationSet?
        mModalInAnim = loadAnimation(
            getContext(),
            R.anim.modal_in
        ) as AnimationSet?
        mModalOutAnim = loadAnimation(
            getContext(),
            R.anim.modal_out
        ) as AnimationSet?
